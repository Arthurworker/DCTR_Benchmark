...
class Objective:
    ...
    def __call__(self, trial: Trial) -> float:
        ...
        model = UDIPSCTR(self.model_opt, self.dataset, self.model, self.optimizer, self.data_dir,
...
def udipsctr(model_opt, dataset, model, data_dir, seed=0, bsize=256, beta1=0.5, lr=5e-4, l2=1e-5, n_trials=100,
    ...
    if searcher == 'grid':
        ...
        model = UDIPSCTR(model_opt, dataset, model, optimizer, data_dir, bsize, beta1, lr, l2, cuda).to(device)
